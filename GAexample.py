...
class Individual:
    ...
    def __init__(self, chromosome=None):
        #calls the make chromosome function if the make chromosome 
        #function is set to none 
        self.chromosome = chromosome or self._makechromosome()
        self.score = None  # set during evaluation
        
    #make a chromosome 30 alleles long and return it 
    def _makechromosome(self):
        "makes a chromosome from randomly selected alleles."
        return [random.choice(self.alleles) for gene in range(self.length)]
    #holder function for evaluating the fitness
    def evaluate(self, optimum=None):
        "this method MUST be overridden to evaluate individual fitness score."
        pass
        
    #calls the twopoint method for other and returns it 
